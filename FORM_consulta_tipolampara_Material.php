...
<table width="100%" height="1001" align="center" >
  ...
  <tr>
	...
	<form id="form1" name="form1" method="post" action="neg_consultar_Tipolampara_Material.php">
     <label></label>
     <p>
       <label> </label>
       <label></label>
     </p>
      <table summary="" width="419" height="113" border="0" align="center">
        <tr>
          <td height="29">Seleccione el Tipo de lampara: </td>
          <td><label>
        ...
        <tr>
          <td width="283" height="29">Seleccione el Material: </td>
          <td width="126"><label>
            <select name="material" id="material">
              <option value="Seleccione">Selccione</option>
        ...
        <tr>
          <td height="47" colspan="2"><div align="center">
            <table width="88" border="0">
              <tr>
                <td><a href="neg_consultar_Tipolampara_Material.php">
