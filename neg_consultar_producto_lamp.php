...
<table width="100%" height="1001" align="center" >
 ...
 public function consultarProducto($tipo_lampara)
 {
 	include ('conexion.php');
		
	
	$sql="SELECT * FROM producto WHERE fk_tipo_producto='$tipo_lampara'";
		...
		echo"<td >Descripcion</td>";				
  		...
  		echo"</tr>";
			...
			while ($row2 = $result2->fetch_assoc())
			{
				...
				$sql3="SELECT * FROM tipo_lampara WHERE id_tipo_producto='$tipo_lampara'";
			...
			{
				$ttipo_lampara= stripslashes($row3["tipo_producto"]);
			}	
 ...
 $nuevo= new Producto();
 $nuevo-> consultarProducto($_POST['tipo_lampara']); 
 ?>
      </div></td>
  </tr>
  <tr>
