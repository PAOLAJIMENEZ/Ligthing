...
<body>
<table width="100%" height="1088" align="center" >
  <tr>
  ...
  <tr>
 <td height="547"><form id="form1" name="form1" method="post" action="neg_consultar_producto_estado.php">
