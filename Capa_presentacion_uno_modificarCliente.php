  ...
  <tr>
    <td width="1280" height="742"><table width="161">
      ...
      <table width="498" height="479" border="3" align="center" cellspacing="20" bordercolor="#000000">
        <tr>
          <td width="448" height="71"><div align="center" class="Titulo"><span class="TituloForm Estilo24  Estilo30">Modificar cliente </span><br />
                  <br />
          </div></td>
        </tr>
        <form id="form1" name="form1" method="post" action="Capa_presentacion_modificarCliente.php" >
          <tr>
            <td><div align="left" class="Tformulario Estilo23">
                ...
                <div align="center">
                  ...
                  <p><a href="neg_registrar_cliente.php">
                    <input name="Submit" type="submit" class="btn-warning" id="Submit" value="Buscar" /></a></p>
                  <p>&nbsp;</p>
