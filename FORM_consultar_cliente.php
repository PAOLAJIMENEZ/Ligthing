...
<table width="100%" height="1001" align="center" >
  ...
  <tr>
    <td width="1280" height="541">
	 <tr>
 <td height="547"><form id="form1" name="form1" method="post" action="neg_consultar_cliente.php">
   <table summary="" width="823" border="0" align="center">
     <tr>
       ...
       <td width="265" height="246"><p>&nbsp;</p>
         <p>Ingrese el documento del cliente: </p>
         </td>
       <td width="169" rowspan="2" align="right"><input name="documento" type="text" id="documento" size="30" /></td>
     </tr>
     <tr>
       <td><div align="center">
