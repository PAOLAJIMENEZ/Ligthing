...
<table width="100%" height="1001" align="center" >
 ...
 public function consultarProducto($estado)
 {
 	include ('conexion.php');
		
	
	$sql="SELECT * FROM producto WHERE fk_estado='$estado'";
		...
		echo"<td >Descripcion</td>";				
  		...
  		echo"</tr>";
			...
			$sql4="SELECT * FROM estado WHERE id_estado='$estado'";
			...
			{
				$eestado= stripslashes($row4["estado"]);
			}	
 ...
 $nuevo= new Producto();
 $nuevo-> consultarProducto($_POST['estado']); 
 ?>
      </div></td>
  </tr>
  <tr>
