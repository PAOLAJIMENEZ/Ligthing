...
<body>
<table width="100%" height="1081" align="center" >
  <tr>
  ...
  <tr>
 <td height="547"><form id="form1" name="form1" method="post" action="neg_consultar_producto_nombre.php">
   <table summary="" width="823" border="0" align="center">
     <tr>
       ...
       <td width="265" height="246"><p>&nbsp;</p>
         <p>Ingrese el nombre del producto : </p>         </td>
